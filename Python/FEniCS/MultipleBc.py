#The following in an example on how to implement Multiple BC in FEniCS, it is copied from
#"https://fenicsproject.org/olddocs/dolfin/latest/python/demos/subdomains-poisson/documentation.html?highlight=measure"
