...
# The actual problem is a quarter plate. The temperature on the left surface is higher than ambient; this is specified
#There is flux free boundary conditions on all the surfaces. 
...
bc3 = DirichletBC(V.sub(1), DThole, left)
bcs = [bc1, bc2, bc3]
