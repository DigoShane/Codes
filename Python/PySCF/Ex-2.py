#This is the second example, wehre we study how to input the geometery.
# by default pyscf will assume inputs are in angstroms.
# However output is in bohr units.
#============================================================================
