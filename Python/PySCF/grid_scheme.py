...
#These are examples of how to implement numerical integration in DFT.
...
mol = gto.M(
    ...
    h    0    -0.757   0.587
    h    0    0.757    0.587''',
    basis = '6-31g') # initialize molecule object.
method = dft.RKS(mol) #Specifying the method.
print('Default DFT(LDA).  E = %.12f' % method.kernel()) # method.kernel() runs the calculations, and prints out the SCF energy.
