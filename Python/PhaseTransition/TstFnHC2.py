...
#Defining Variables
####################################################################################################
N1 = 181 #int(input("Enter # terms to Truncate to: "))
N2 = 181 #int(input("Enter # terms to Truncate to: "))
if N1%2 == 0 & N2%2 ==0:
...
def utest(u1p,u2p):
 ...
 for i in range(len(u1p)):
  for j in range(len(u2p)):
   ...
   ### #Benchmark Test function -1
   ### #------------------------------------------------------------------------------------------------------------------
   ### z[j][i] = np.cos(2*np.pi*3*u1)*np.cos(2*np.pi*2*u2)
   ### #------------------------------------------------------------------------------------------------------------------
   ### #Benchmark Test function -2
   ### #------------------------------------------------------------------------------------------------------------------
   ### z[j][i] = 1
...
#####################################################################################################
def Energy(u1,u2,Zu,Z,AZ1,AZ2, fz):
...
u1prime = np.linspace(0,1-deltau1, N1)
u2prime = np.linspace(0,1-deltau2, N2)
...
###       for row in np.around(AZ1,6)]))
### print("--------------------------------------------------------")
### print("AZ2 = A_2(x_k)")
### print('\n'.join([''.join(['{:15}'.format(item) for item in row]) 
###       for row in np.around(AZ2,6)]))
### print("--------------------------------------------------------")
### print("|A|^2 =")
### print('\n'.join([''.join(['{:15}'.format(item) for item in row]) 
###       for row in np.around(np.multiply(AZ1,AZ1) + np.multiply(AZ2,AZ2),6)]))
### print("--------------------------------------------------------")
### Hh = H*np.ones((len(u1prime),len(u2prime)))
### print("|H-h|^2 =")
### print('\n'.join([''.join(['{:15}'.format(item) for item in row]) 
###       for row in np.around(np.multiply(Hh-Z, Hh-Z),6)]))
print("Energy associated with thhe test function =", Energy(u1prime, u2prime, Zu, Z , AZ1, AZ2, FZbN)) 

fig, ax = plt.subplots(subplot_kw={"projection": "3d"})
###xDx# Plot the surface.
##------------------------------------------------------------------------------------------------
