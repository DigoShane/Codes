...
solve(F == 0, Au, bcs,
   #solver_parameters={"newton_solver":{"convergence_criterion":"residual","relaxation_parameter":0.001,"relative_tolerance":0.000001,"absolute_tolerance":033.4000601,"maximum_iterations":1000}})
   solver_parameters={"newton_solver":{"convergence_criterion":"residual","relaxation_parameter":rlx_par,"relative_tolerance":0.000001,"absolute_tolerance":tol_abs,"maximum_iterations":1000}})
...
#   print('{:16.8f}'.format(coord[0]), '{:16.8f}'.format(val1), '{:16.8f}'.format(val2), file=outfile)#Storing (x, A(x), u(x))
