...
#------------------------------------------------------------------------------------------------------
#This is helpful in extending solutions from smaller domains onto larger domains.
#The initial conditions and runs for this can be found in Linux.../Desktop/Codes/FEniCS/GinzburgLandau{/., /plots/Const/ExtrapolateInitialGuess/.}
